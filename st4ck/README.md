...
- **QA Author code isolation is prompt-based** — the agent has Read access to the full codebase (needed for UI label verification) but is instructed to test from specs, not code
